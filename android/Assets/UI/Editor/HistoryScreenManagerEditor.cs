...
{
    /// <summary>
    /// Editor скрипт для автоматической настройки HistoryScreenManager
    /// </summary>
    [CustomEditor(typeof(HistoryScreenManager))]
    [CanEditMultipleObjects]
    public class HistoryScreenManagerEditor : UnityEditor.Editor
    {
        private void OnEnable()
        {
            HistoryScreenManager manager = (HistoryScreenManager)target;
            ...
            SerializedProperty uxmlProp = serializedObject.FindProperty("historyScreenUXML");
            SerializedProperty ussProp = serializedObject.FindProperty("historyScreenStyleSheet");
            ...
            if (uxmlProp.objectReferenceValue == null)
            {
                ...
                string resourcesPath = "Assets/Resources/UI/Views/HistoryScreen/HistoryScreen.uxml";
                ...
                if (uxml == null)
                {
                    string uxmlPath = "Assets/UI/Views/HistoryScreen/HistoryScreen.uxml";
            ...
            {
                // Пробуем загрузить из Resources
                string resourcesPath = "Assets/Resources/UI/Views/HistoryScreen/HistoryScreen.uss";
                StyleSheet uss = AssetDatabase.LoadAssetAtPath<StyleSheet>(resourcesPath);
                
                // Если не найдено в Resources, пробуем из Assets/UI/Views (обратная совместимость)
                if (uss == null)
                {
                    string ussPath = "Assets/UI/Views/HistoryScreen/HistoryScreen.uss";
            ...
            if (uiDocument != null)
            {
                ...
                if (panelSettingsProp.objectReferenceValue == null)
                {
                    ...
                    if (panelSettings == null)
                    {
                        ...
                        Debug.Log($"[HistoryScreen] Создан PanelSettings: {panelSettingsPath}");
                    }
