...
{
    /// <summary>
    /// Editor скрипт для автоматической настройки MarkersScreenManager
    /// </summary>
    [CustomEditor(typeof(MarkersScreenManager))]
    [CanEditMultipleObjects]
    public class MarkersScreenManagerEditor : UnityEditor.Editor
    {
        private void OnEnable()
        {
            MarkersScreenManager manager = (MarkersScreenManager)target;
            ...
            SerializedProperty uxmlProp = serializedObject.FindProperty("markersScreenUXML");
            SerializedProperty ussProp = serializedObject.FindProperty("markersScreenStyleSheet");
            ...
            if (uiDocument != null)
            {
                ...
                if (panelSettingsProp.objectReferenceValue == null)
                {
                    ...
                    if (panelSettings == null)
                    {
                        ...
                        Debug.Log($"[MarkersScreen] Создан PanelSettings: {panelSettingsPath}");
                    }
