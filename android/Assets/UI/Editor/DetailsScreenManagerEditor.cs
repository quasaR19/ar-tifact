...
{
    /// <summary>
    /// Editor скрипт для автоматической настройки DetailsScreenManager
    /// </summary>
    [CustomEditor(typeof(DetailsScreenManager))]
    [CanEditMultipleObjects]
    public class DetailsScreenManagerEditor : UnityEditor.Editor
    {
        private void OnEnable()
        {
            DetailsScreenManager manager = (DetailsScreenManager)target;
            ...
            SerializedProperty uxmlProp = serializedObject.FindProperty("screenUXML");
            SerializedProperty ussProp = serializedObject.FindProperty("screenStyleSheet");
            ...
            if (uxmlProp.objectReferenceValue == null)
            {
                ...
                string resourcesPath = "Assets/Resources/UI/Views/DetailsScreen/DetailsScreen.uxml";
                ...
                if (uxml == null)
                {
                    string uxmlPath = "Assets/UI/Views/DetailsScreen/DetailsScreen.uxml";
            ...
            {
                // Пробуем загрузить из Resources
                string resourcesPath = "Assets/Resources/UI/Views/DetailsScreen/DetailsScreen.uss";
                StyleSheet uss = AssetDatabase.LoadAssetAtPath<StyleSheet>(resourcesPath);
                
                // Если не найдено в Resources, пробуем из Assets/UI/Views (обратная совместимость)
                if (uss == null)
                {
                    string ussPath = "Assets/UI/Views/DetailsScreen/DetailsScreen.uss";
            ...
            if (uiDocument != null)
            {
                ...
                if (panelSettingsProp.objectReferenceValue == null)
                {
                    ...
                    if (panelSettings == null)
                    {
                        ...
                        Debug.Log($"[DetailsScreen] Создан PanelSettings: {panelSettingsPath}");
                    }
